...
$stmt = $pdo->prepare('UPDATE php03_kadai_table SET name = :name, email = :email, age = :age, content = :content, indate = sysdate(), shopname = :shopname, station = :station, address = :address, category = :category, openingtime = :openingtime, closingtime = :closingtime, averagevisitors = :averagevisitors, devicetype = :devicetype, segment1 = :segment1, segment2 = :segment2, segment3 = :segment3, tag1 = :tag1, tag2 = :tag2, tag3 = :tag3, image = :image  WHERE id = :id;');
...
$stmt->bindValue(':openingtime', $openingtime, PDO::PARAM_INT);
$stmt->bindValue(':closingtime', $closingtime, PDO::PARAM_INT);
